...
# Date     : 2026-04-22
# Usage    : python scr/run_benchmark.py
#            python scr/run_benchmark.py --dry-run   (5 episodes, quick check)
...
def main(n_mc: int = N_MC, verbose: bool = True) -> str:
    ...
    if verbose:
        print("=" * 72)
        print("run_benchmark.py — Monte Carlo Benchmark Evaluation")
    ...
    out_path = os.path.join(OUTPUT_DIR, "raw_results.npz")
