...
# Outputs  : image/fig1_b4_ucum_comparison.png
#            image/fig2_b4_pfail.png
#            image/fig3_b4_nonstationarity.png
#            image/fig4_b4_climate_scenarios.png
#            image/convergence_check_b4.png
...
from pomdp_env_b4 import T, GAMMA, SEED, FAILURE_STATE, CLIMATE_SWITCH_STEP
...
COND_LABEL  = {"stationary": "SSP2-4.5 recharge (base)", "nonstationary": "SSP5-8.5 drying (shifted)"}
...
def fig1_ucum(res: dict) -> str:
    ...
    return _savefig(fig, "fig1_b4_ucum_comparison.png")
...
def fig2_pfail(res: dict) -> str:
    ...
    fig.suptitle("Fig 2 — Storage Failure Metrics (B2 MAR) by Policy and Condition",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "fig2_b4_pfail.png")
...
def fig3_nonstationarity(npz) -> str:
    ...
    fig.suptitle("Fig 3 — Per-Step Mean Reward Trajectory",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "fig3_b4_nonstationarity.png")
...
def fig4_evoi(res: dict) -> str:
    ...
    fig.suptitle("Fig 4 — Climate Scenario Value (B2 MAR) (EVOI) Decomposition",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "fig4_b4_climate_scenarios.png")
...
def fig5_convergence(res: dict) -> str:
    ...
    fig.suptitle("Fig 5 — Convergence Check: SE of Mean U_cum vs N_MC",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "convergence_check_b4.png")
