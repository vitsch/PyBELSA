...
# Date     : 2026-04-25
# Usage    : python scr/run_benchmark_b10.py
#            python scr/run_benchmark_b10.py --dry-run   (5 episodes, quick check)
...
def main(n_mc: int = N_MC, verbose: bool = True) -> str:
    ...
    if verbose:
        print("=" * 72)
        print("run_benchmark_b10.py — MC Evaluation (Benchmark 10)")
    ...
    out_path = os.path.join(OUTPUT_DIR, "raw_results_b10.npz")
