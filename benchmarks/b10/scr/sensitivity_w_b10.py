# =============================================================================
# sensitivity_w_b10.py  —  Hybrid Belief Update T-Sensitivity (Benchmark 6)
...
# Date     : 2026-04-25
# Usage    : python scr/sensitivity_w_b10.py
# Outputs  : output/sensitivity_w_results_b10.csv
#            output/sensitivity_w_report_b10.md
# =============================================================================
"""
T-Sensitivity Analysis for Benchmark 10 (Sahel / Lake Chad Basin Quaternary Aquifer):
...
Seeding: M_IDX_BASE=100 to avoid collision with run_benchmark_b10 (m_idx 0-15).
"""
...
from run_benchmark_b10 import _run_episode, _update_belief
...
def main():
    t_start = time.time()
    print("=" * 72)
    print("sensitivity_w_b10.py — T-Sensitivity Analysis (Benchmark 6 Sahel / Lake Chad Basin Quaternary Aquifer)")
    ...
    print(f"\n{'='*72}")
    print(f"B10 sensitivity run complete in {elapsed:.1f}s  ({elapsed/60:.1f} min)")

    csv_path = os.path.join(OUTPUT_DIR, "sensitivity_w_results_b10.csv")
    ...
    md_path = os.path.join(OUTPUT_DIR, "sensitivity_w_report_b10.md")
    lines_md = [
