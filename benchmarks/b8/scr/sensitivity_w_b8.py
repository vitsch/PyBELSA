# =============================================================================
# sensitivity_w_b8.py  —  Hybrid Belief Update T-Sensitivity (Benchmark 6)
...
# Date     : 2026-04-25
# Usage    : python scr/sensitivity_w_b8.py
# Outputs  : output/sensitivity_w_results_b8.csv
#            output/sensitivity_w_report_b8.md
# =============================================================================
"""
T-Sensitivity Analysis for Benchmark 8 (Stampriet Transboundary Aquifer STAS):
...
Seeding: M_IDX_BASE=100 to avoid collision with run_benchmark_b8 (m_idx 0-15).
"""
...
from run_benchmark_b8 import _run_episode, _update_belief
...
def main():
    t_start = time.time()
    print("=" * 72)
    print("sensitivity_w_b8.py — T-Sensitivity Analysis (Benchmark 6 Stampriet Transboundary Aquifer STAS)")
    ...
    print(f"\n{'='*72}")
    print(f"B8 sensitivity run complete in {elapsed:.1f}s  ({elapsed/60:.1f} min)")

    csv_path = os.path.join(OUTPUT_DIR, "sensitivity_w_results_b8.csv")
    ...
    md_path = os.path.join(OUTPUT_DIR, "sensitivity_w_report_b8.md")
    lines_md = [
