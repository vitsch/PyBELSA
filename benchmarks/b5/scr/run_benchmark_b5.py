...
# Project  : ELS_NEW / P_Base  (Benchmark 5 — NCP GRACE)
# Plan ref : experiment_plan.md §5 Step 4
# Date     : 2026-04-25
# Usage    : python scr/run_benchmark_b5.py
#            python scr/run_benchmark_b5.py --dry-run   (5 episodes, quick check)
...
def main(n_mc: int = N_MC, verbose: bool = True) -> str:
    ...
    if verbose:
        print("=" * 72)
        print("run_benchmark_b5.py — MC Evaluation (Benchmark 2)")
    ...
    out_path = os.path.join(OUTPUT_DIR, "raw_results_b5.npz")
