# =============================================================================
# sensitivity_w_b5.py  —  Hybrid Belief Update T-Sensitivity (Benchmark 5)
...
# Date     : 2026-04-25
# Usage    : python scr/sensitivity_w_b5.py
# Outputs  : output/sensitivity_w_results_b5.csv
#            output/sensitivity_w_report_b5.md
# =============================================================================
"""
T-Sensitivity Analysis for Benchmark 5 (North China Plain GRACE):
...
Key B5 differences from B4:
  ...
  Conditions: long-term average (stationary) / SSP5-8.5 demand increase at t=15
  U_T ≈ 0.7–0.9 (GRACE noise + sparse monitoring — highest in suite)
  SIGMA_OBS=45 (wider than B4=35; GRACE footprint aggregation)

Seeding: M_IDX_BASE=100 to avoid collision with run_benchmark_b5 (m_idx 0-15).
"""
...
from run_benchmark_b5 import _run_episode, _update_belief
...
def main():
    t_start = time.time()
    print("=" * 72)
    print("sensitivity_w_b5.py — T-Sensitivity Analysis (Benchmark 5 NCP GRACE)")
    ...
    csv_path = os.path.join(OUTPUT_DIR, "sensitivity_w_results_b5.csv")
    ...
    md_path = os.path.join(OUTPUT_DIR, "sensitivity_w_report_b5.md")
    lines_md = [
