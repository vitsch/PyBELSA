# =============================================================================
# figures.py  —  Publication-Quality Figures for Benchmark 7
# Project  : ELS_NEW / P_Base  (Benchmark 7 — Coastal Saltwater Intrusion)
# Plan ref : experiment_plan.md §5 Step 6
# Date     : 2026-04-25
# Usage    : python scr/figures_b2.py  (in P_Base2/scr/)
# Inputs   : output/raw_results.npz
# Outputs  : image/fig1_b7_ucum_comparison.png
#            image/fig2_b7_pfail.png
#            image/fig3_b7_nonstationarity.png
#            image/fig4_b7_climate_scenarios.png
#            image/convergence_check_b7.png
...
from pomdp_env_b7 import T, GAMMA, SEED, FAILURE_STATE, CLIMATE_SWITCH_STEP
...
# Paths
# ---------------------------------------------------------------------------
NPZ_PATH   = os.path.join(os.path.dirname(_HERE), "output", "raw_results_b7.npz")
...
def fig1_ucum(res: dict) -> str:
    ...
    return _savefig(fig, "fig1_b7_ucum_comparison.png")
...
def fig2_pfail(res: dict) -> str:
    ...
    fig.suptitle("Fig 2 — Storage Failure Metrics (B2 MAR) by Policy and Condition",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "fig2_b7_pfail.png")
...
def fig3_nonstationarity(npz) -> str:
    ...
    fig.suptitle("Fig 3 — Per-Step Mean Reward Trajectory",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "fig3_b7_nonstationarity.png")
...
def fig4_evoi(res: dict) -> str:
    ...
    fig.suptitle("Fig 4 — Climate Scenario Value (B2 MAR) (EVOI) Decomposition",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "fig4_b7_climate_scenarios.png")
...
def fig5_convergence(res: dict) -> str:
    ...
    fig.suptitle("Fig 5 — Convergence Check: SE of Mean U_cum vs N_MC",
                 fontsize=TITLE_FS + 1)
    return _savefig(fig, "convergence_check_b7.png")
